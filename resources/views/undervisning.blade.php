    ...
    <div class="content-container">
        ...
        <section id="features-section"
            ...
            <div class="max-w-full mx-auto text-center">
                <h2 class="text-[28px] mb-8 font-bold text-[#1E1E1E]">
                    Lektionsplan-funktioner – Klar til brug og tilpasning
                </h2>
                <p class="text-[#858599] mb-8 text-[16px]">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    @foreach ($features as $index => $feature)
                        <div class="relative bg-white rounded-2xl shadow-md p-6 flex flex-col items-start 
                            ...
                            <h3
                                class="text-lg text-start font-semibold text-[#1E1E1E] mb-2 relative z-10 group-hover:text-[#248ec1] transition-colors duration-300">
                                {{ $feature['title'] }}
                            </h3>
                            <p
        ...
        <section id=" undervisning-tilpasset"
            ...
            <div
                ...
                <p class="text-[#858599]  text-sm">
                    Systemet fungerer intuitivt – både til klasseundervisning og online teori. Du kan nemt tilpasse alt
        ...
        <p class="text-[#858599] w-full text-center bg-[#F3F8FD] py-5 text-[16px]">
        ...
        <section id="online-teoriprøver"
            ...
            <div
                class="w-full md:w-1/2 space-y-4 opacity-0 translate-y-10 transition-all duration-700 ease-out animate-on-scroll delay-200">
                <h2 class="text-[20px] capitalize font-bold text-[#1E1E1E]">
                ...
                <ul class="space-y-6 text-[] text-sm font-semibold mt-4">
                    <li class="flex items-start gap-2">
                        <img src="{{ asset('images/arrowNew.png') }}" alt="Arrow Right" class="w-4 h-4 text-[#3384FF]">
